...
class PossessMan2Controller extends ParentController
{
...
//eBay 责任归属人2
    ...
    public function purchase_netprofit(){
        ...
        $sql = "exec P_YR_PossessMan2Profit '$data[DateFlag]','$data[BeginDate]','$data[EndDate]','','','0','eBay','','','','','','0','0','0',0";
//        echo $sql;die;
        $result = $M->query($sql);
        session('result',$result);
        $this->display('possessMan2_netprofit');
