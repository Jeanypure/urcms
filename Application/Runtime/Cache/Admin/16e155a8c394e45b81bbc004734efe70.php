        ...
        return {
            ...
            init: function () {
                ...
                function editRow(oTable, nRow) {
                    ...
                    jqTds[3].innerHTML = '<select name="department" class="form-control input-small" ><option value="1">运营一部</option>  <option value="2">运营二部</option> <option value="3">运营三部</option> <option value="5">运营五部</option> <option value="6">运营六部</option><option value="7">郑州分部</option><option value="8">未分配</option><option value="9">郑州分部eBay1</option><option value="10">郑州分部eBay2</option><option value="11">郑州分部Shopee</option></select>';
