...
<!-- END SIDEBAR -->
    ...
    <div class="page-content">
        ...
        <div class="devcondition-page">
            <div class="col-md-12">

                <form class="form-horizontal myclass" action="<?php echo U('Developer/Index/test');?> " method="POST">
                    <!--<?php echo U('Demo/index/test');?>-->
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-1 " >
                                    <select  name="department" class="form-control">
                                        <!--id="dev-department"-->
                                        <option value=""></option>
                                        <?php if(is_array($department)): $i = 0; $__LIST__ = $department;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>

                                </div>
                                <label for="salername" class="col-sm-1 control-label selectpicker" multiple data-actions-box="true" >业绩归属人</label>
                                <div class="col-sm-1" >
                                    <select name="salername" id="dev-salername-select" class="form-control">
                                        <option value=""></option>
                                        <?php if(is_array($dev)): $i = 0; $__LIST__ = $dev;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
