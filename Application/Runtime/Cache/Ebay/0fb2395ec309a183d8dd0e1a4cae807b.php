...
<!-- END SIDEBAR -->
    ...
    <div class="page-content">
        ...
        <div class="row page">
            <div class="col-md-12">
                <form class="form-horizontal myclass"  action="<?php echo U('Ebay/PossessMan2/purchase_netprofit');?> " method="post">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-globe"></i>eBay毛利报表</div>
                            <div class="tools">                               
