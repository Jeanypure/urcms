...
<!-- END SIDEBAR -->
    ...
    <div class="page-content">
        ...
        <div class="row page">
            <div class="col-md-12">
                <form class="form-horizontal myclass"  action="<?php echo U('Purchase/Purchase/purchase_netprofit');?> " method="post">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-globe"></i>采购毛利报表</div>
                            <div class="tools">                               
                        ...
                        <div class="portlet-body">
                            <div class="form-group" >
                                <label for="Purchase" class="col-sm-1 control-label" multiple data-actions-box="true">采购</label>
                                <div class="col-sm-1" >
                                    <select name="Purchase"  class="form-control"   >
                                        <!--id="department-user-select"-->
                                        <option value="">--</option>
                                        <?php if(is_array($purchase)): $i = 0; $__LIST__ = $purchase;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["username"]); ?>"><?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
