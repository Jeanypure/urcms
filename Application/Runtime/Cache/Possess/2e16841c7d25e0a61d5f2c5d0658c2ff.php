...
<div class="header navbar " style="margin-bottom: -18px; width:400px">
    ...
    <div class="header-inner">
        ...
        <a  class="navbar-brand" href="<?php echo U('Possess/PossessMan/export');?>" >导出数据
        </a>
    </div>
...
<script>
    ...
    function initTable(tableName) {
        ...
        tableName.bootstrapTable({
            ...
            showColumns:true,
            search:true,
            url:"/Possess/PossessMan/possess",
            columns: [
                [
