...
<!-- END SIDEBAR -->
    ...
    <div class="page-content">
        ...
        <div class="row page">
            <div class="col-md-12">
                <form class="form-horizontal myclass"  action="<?php echo U('Possess/PossessMan/possessman_netprofit');?> " method="post">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-globe"></i>美工毛利报表</div>
                            <div class="tools">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-1" >
                                    <select  name="department" class="form-control" id="department">
                                        <option value="">--</option>
                                        <?php if(is_array($department)): $i = 0; $__LIST__ = $department;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dep): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($dep); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <label for="possess" class="col-sm-1 control-label" multiple data-actions-box="true">责任归属人</label>
                                <div class="col-sm-1" >
                                    <select name="possessMan1"  class="form-control"   >
                                        <!--id="department-user-select"-->
                                        <option value="">--</option>
                                        <?php if(is_array($possess)): $i = 0; $__LIST__ = $possess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <div class="col-sm-1">
                                    <select name="DateFlag" class="col-sm-1 form-control">
...
<script>
    $(document).ready(function(){
        ...
        $('#department').change(function(){
            ...
            $.ajax({
                url:"<?php echo U('Possess/PossessMan/fetch_possess');?>",
                type:'GET',
